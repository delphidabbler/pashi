 ...
 *
 * The Original Code is UPipe.pas from PasHGUI.
 *
  ...
  public
    constructor Create(const Size: LongWord = 0);
      {Class constructor. Creates a new pipe with inheritable handles.
        @param Size [in] Required size of pipe. If Size is 0 default pipe size
          used.
      }
    ...
    function ReadData(var Buf; const BufSize: LongWord;
      ...
      {Reads data from pipe into a buffer.
        @param Buf [in] Buffer receiving data. Must have capacity of at least
          BufSize bytes.
        @param BufSize [in] Size of buffer or number of bytes requested.
        @param BytesRead [in/out] Set to number of bytes actually read.
...
constructor TPipe.Create(const Size: LongWord = 0);
  {Class constructor. Creates a new pipe with inheritable handles.
    @param Size [in] Required size of pipe. If Size is 0 default pipe size used.
  }
var
