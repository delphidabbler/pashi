@rem ---------------------------------------------------------------------------
@rem Script used to build the DelphiDabbler PasH project
@rem
@rem Copyright (C) Peter Johnson (www.delphidabbler.com), 2007
@rem
@rem v1.0 of 10 Mar 2007 - First version that builds project.
@rem v1.1 of 29 May 2009 - Revised to use renamed Resources.rc.
@rem
@rem Requires:
@rem   Borland Delphi7
...
echo DelphiDabbler PasH Build Script
echo -------------------------------
echo "%~dp0"
prompt
goto Config
...
title DelphiDabbler PasH Build File
