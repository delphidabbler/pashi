...
privileges to install it. Elevation may be required to install on Windows Vista and later.
...
The installer makes the following changes to your system:
  ...
  * The main program's executable files and documentation are installed into the 
    chosen install folder (%ProgramFiles%\DelphiDabbler\PasHi by default). If 
    you  chose to install it, PasHiGUI will also be placed in this directory.
...
For details please see the file LICENSE that is installed in the same directory 
